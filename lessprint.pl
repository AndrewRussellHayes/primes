...
my $currentNumber = 4; #TODO: or read in value if it exists
...
chomp $filename;
my $lastPrinted = 0;#TODO: when importing progress make sure to update this
...
sub logPrime {
	...
	foreach my $i ($lastPrinted .. $#primes){
